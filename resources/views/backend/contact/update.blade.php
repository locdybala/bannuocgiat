        ...
        <div class="col-lg-8 col-md-10">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update_info',['id'=>$contactUpdate->info_id])}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="mb-3">
                            ...
                            @if($contactUpdate->info_image)
                                <div class="mt-2">
                                    <img id="logo-preview" src="{{ asset('frontend/images/logo/'.$contactUpdate->info_image) }}" height="120" style="max-width: 200px; border-radius: 8px; border: 1px solid #eee;" alt="Logo">
                                </div>
                            @else
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="ckeditor" class="form-control" name="info_name" placeholder="">{!! $contactUpdate->info_contact !!}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="info_map" class="form-label">Bản đồ</label>
                            <textarea rows="4" class="form-control" id="info_map" name="info_map" placeholder="Nhúng iframe bản đồ hoặc mô tả">{{ $contactUpdate->info_map }}</textarea>
                        </div>
