    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <h1 class="mb-0 bread">{{ $category_name->category_name }}</h1>
            </div>
        </div>
    </div>
</div>
<section class="ftco-section">
    <div class="container">
        ...
        {{-- Thanh lọc sản phẩm theo danh mục (thay thế cho sidebar) --}}
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    {{-- Lặp qua danh sách danh mục của bạn --}}
                    @foreach ($category as $categori)
                    <li>
                        {{-- Đánh dấu 'active' cho danh mục đang được chọn --}}
                        <a href="{{ route('detailCategory',['id'=>$categori->category_id]) }}" class="{{ $category_name->category_id == $categori->category_id ? 'active' : '' }}">
